...
public class BoardPanel extends JPanel {
	 ...
	 */
	private static final Font LARGE_FONT = new Font("맑은 고딕",Font.ITALIC, 24);

	/**
	 * The smaller font to display.
	 */
	private static final Font SMALL_FONT = new Font("맑은 고딕",Font.ITALIC, 12);
	...
	public void paintComponent(Graphics g) {
		...
		if(tetris.isPaused()) {
			 ...
			 */
			String msg = tetris.isNewGame() ? "테트리스" : "게임 오버";
			g.drawString(msg, CENTER_X - g.getFontMetrics().stringWidth(msg) / 2, 150);
			g.setFont(SMALL_FONT);
			msg = "엔터키를 눌러 주세요." + (tetris.isNewGame() ? "" : " 재시작");
